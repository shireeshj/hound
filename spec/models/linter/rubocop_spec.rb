  ...
  describe "#file_review" do
    ...
    describe "#file_included?" do
      ...
      context "with included file" do
        it "returns true" do
          config = stub_rubocop_config("AllCops" => { "Exclude" => [] })
    ...
    def violations_with_config(config = stub_rubocop_config)
    ...
    def stub_rubocop_config(config = {})
      stubbed_rubocop_config = double("RubocopConfig", content: config)
      allow(Config::Rubocop).to receive(:new).and_return(stubbed_rubocop_config)

      stubbed_rubocop_config
    end
